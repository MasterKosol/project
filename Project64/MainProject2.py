...
class PotentiometerGUI:
    def __init__(self, root):
        ...
        self.label1 = tk.Label(root, text="Potentiometer 1 Value:", font=("Helvetica", 12, "bold"))
        self.label1.pack()

        self.pot1_value_var = tk.StringVar()
        self.pot1_value_label = tk.Label(root, textvariable=self.pot1_value_var, font=("Helvetica", 12))
        self.pot1_value_label.pack()

        self.label2 = tk.Label(root, text="Potentiometer 2 Value:", font=("Helvetica", 12, "bold"))
        self.label2.pack()

        self.pot2_value_var = tk.StringVar()
        self.pot2_value_label = tk.Label(root, textvariable=self.pot2_value_var, font=("Helvetica", 12))
    ...
    def setup_motor_control_gui(self):
        ...
        self.motor1_label = tk.Label(self.root, text="MOTOR1: 0", font=("Helvetica", 12))
        ...
        self.motor2_label = tk.Label(self.root, text="MOTOR2: 0", font=("Helvetica", 12))
        self.motor2_label.pack(pady=10)

        # Buttons
        self.led_state_var = tk.BooleanVar()
        self.led_button = tk.Button(self.root, text="Reverse", command=self.toggle_led, font=("Helvetica", 12, "bold"), bg="red", fg="white")
        self.led_button.pack(pady=10)

        self.mode_state_var = tk.BooleanVar()
        self.mode_button = tk.Button(self.root, text="Mode", command=self.toggle_mode, font=("Helvetica", 12, "bold"), bg="blue", fg="white")
        self.mode_button.pack(pady=10)

        self.home_state_var = tk.BooleanVar()
        self.home_button = tk.Button(self.root, text="HOME", command=self.toggle_home, font=("Helvetica", 12, "bold"), bg="green", fg="white")
